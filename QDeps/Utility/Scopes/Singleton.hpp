    ...
    #ifndef QDEPS_UTILITY_SCOPES_SINGLETON_HPP
    #define QDEPS_UTILITY_SCOPES_SINGLETON_HPP
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, QDEPS_FUNC_ARITY, "QDeps/Utility/Scopes/Singleton.hpp"))
