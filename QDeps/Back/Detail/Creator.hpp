    ...
    #define QDEPS_CREATOR_IMPL(z, n, text)                                                      \
        ...
        {                                                                                       \
            return p_dependency.create(                                                         \
                ...
                BOOST_PP_REPEAT(n, QDEPS_CREATOR_IMPL_ARG, ~)                                   \
            );                                                                                  \
        }

    BOOST_PP_REPEAT(QDEPS_FUNCTION_ARITY_LIMIT_SIZE, QDEPS_CREATOR_IMPL, ~)

    #undef QDEPS_CREATOR_IMPL_ARG
    #undef QDEPS_CREATOR_IMPL
};
