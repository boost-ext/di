...
//
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, QDEPS_FUNCTION_ARITY_LIMIT_SIZE, "QDeps/Back/Policies/CircularDependencies.hpp"))
    ...
    public:
        ...
        class Assert
        {
            ...
            template<typename, typename, typename = void, typename = void> struct CircularDependenciesImplHelper;

            template<typename T, typename TCallStack, typename = void, typename = void>
            struct CircularDependenciesImpl : CircularDependenciesImplHelper
                <
        ...
        public:
            typedef CircularDependenciesImpl<TGiven, boost::mpl::vector0<> > type;
        };
    };
    ...
    #define QDEPS_CIRCULAR_DEPENDENCIES_IMPL(z, n, _) BOOST_PP_COMMA_IF(n)\
        CircularDependenciesImpl<typename Aux::AtCtor<TDependency, n>::type, TCallStack>

    template<typename TDependency, typename TCallStack>
    struct CircularDependenciesImplHelper
        <
            TDependency,
            TCallStack,
    ...
    BOOST_PP_EXPR_IF(BOOST_PP_ITERATION(), :)
        BOOST_PP_REPEAT(BOOST_PP_ITERATION(), QDEPS_CIRCULAR_DEPENDENCIES_IMPL, ~)
    { };
    ...
    #undef QDEPS_CIRCULAR_DEPENDENCIES_IMPL
