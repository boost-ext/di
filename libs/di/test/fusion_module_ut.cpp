...
BOOST_AUTO_TEST_CASE(fusion_module_empty)
{
    ...
    BOOST_CHECK((mpl::equal<mpl::vector0<>, module_t::externals>::value));
}
...
BOOST_AUTO_TEST_CASE(fusion_module_one_scope)
{
    ...
    BOOST_CHECK((mpl::equal<mpl::vector0<>, module::externals>::value));
}
...
BOOST_AUTO_TEST_CASE(fusion_module_externals_base)
{
    struct module
        : fusion_module<
              externals<
...
BOOST_AUTO_TEST_CASE(fusion_module_externals_mix)
{
    struct module
        : fusion_module<
              externals<
...
BOOST_AUTO_TEST_CASE(fusion_module_externals_bind)
{
    struct module
        : fusion_module<
              externals<
...
BOOST_AUTO_TEST_CASE(fusion_module_set_instance_int)
{
    const int i = 42;
...
BOOST_AUTO_TEST_CASE(fusion_module_set_instance_annotate_in_in_call)
{
    const int i1 = 42;
    const int i2 = 43;
...
BOOST_AUTO_TEST_CASE(fusion_module_set_instance_annotate_in_name)
{
    const int i1 = 42;
    const int i2 = 43;
...
BOOST_AUTO_TEST_CASE(fusion_module_set_instance_annotatein_name_in_call)
{
    const int i1 = 42;
    const int i2 = 43;
...
BOOST_AUTO_TEST_CASE(fusion_module_set_instance_mix)
{
    const int i1 = 42;
    const int i2 = 43;
    const int i3 = 44;
...
BOOST_AUTO_TEST_CASE(fusion_module_ctor_with_externals)
{
    const int i = 42;
    const double d = 87.0;

    typedef fusion_module<
        externals<
            int
          , double
        >
...
BOOST_AUTO_TEST_CASE(fusion_module_ctor_with_externals_shared_ptr)
{
    const int i = 42;
