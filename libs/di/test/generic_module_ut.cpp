    ...
    BOOST_CHECK((
        mpl::equal<
            mpl::vector<
              ...
              , dependency_base_of<scopes::per_request, c3, c3, mpl::vector<c4, c5> >::type
            >
          , module::dependencies
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(generic_module_in_call)
{
    ...
    BOOST_CHECK((
        mpl::equal<
            mpl::vector<
                dependency_base_of<scopes::per_request, c1, c1, mpl::vector<c2> >::type
            >
          , module::dependencies
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(generic_module_in_namein_call)
{
    ...
    BOOST_CHECK((
        mpl::equal<
            mpl::vector<
                dependency_base_of<scopes::singleton, named<c1, int>, c1, mpl::vector<double> >::type
              , dependency_base_of<scopes::singleton, named<c2, double>, c2, mpl::vector<int> >::type
            >,
            module::dependencies
        >::value
    ));
    ...
    BOOST_CHECK((
        mpl::equal<
            mpl::vector<
              ...
              , dependency_base_of<scopes::per_request, named<int, mpl::string<'2'> >, mpl::int_<4>, mpl::vector<c7, c6, c4> >::type
              , dependency_base_of<scopes::per_request, int, mpl::int_<5>, mpl::vector<c2> >::type
            >
          , module::dependencies
        >::value
    ));
