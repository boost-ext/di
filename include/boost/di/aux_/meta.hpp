...
#include <boost/preprocessor/arithmetic/sub.hpp>
    ...
    #define BOOST_DI_LIMIT_SIZE 20
#endif

#if !defined(BOOST_DI_CTOR_ARITY_LIMIT_SIZE)
    #define BOOST_DI_CTOR_ARITY_LIMIT_SIZE 35
#endif
...
#define BOOST_DI_ITERATION_PARAMS(begin, file)          \
     3, (begin, BOOST_DI_CTOR_ARITY_LIMIT_SIZE, file)
...
#define BOOST_DI_TYPES_PASS_MPL_WITH_TYPE(T, type)      \
     BOOST_PP_REPEAT(                                   \
         BOOST_DI_CTOR_ARITY_LIMIT_SIZE                 \
       , BOOST_DI_ADD_TYPE                              \
       , type                                           \
     )
