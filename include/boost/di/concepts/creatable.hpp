...
#define BOOST_DI_NAMED_ERROR(name, type, error_type, error)                                               \
  aux::conditional_t<aux::is_same<TName, no_name>::value, typename error_type<aux::decay_t<type>>::error, \
...
struct creatable_error_impl<TInitialization, TName, I, T, aux::type_list<TCtor...>>
    : aux::conditional_t<
          ...
          aux::conditional_t<aux::is_same<I, T>::value, BOOST_DI_NAMED_ERROR(TName, T, abstract_type, is_not_bound),
