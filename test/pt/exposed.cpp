...
struct c  { BOOST_DI_INJECT(c, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9) { } };
...
int main() {
    ...
    result+=(injector.create<std::unique_ptr<c>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c0>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c1>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c2>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c3>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c4>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c5>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c6>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c7>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c8>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<c9>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x00>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x01>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x02>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x03>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x04>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x05>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x06>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x07>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x08>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x09>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x10>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x11>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x12>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x13>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x14>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x15>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x16>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x17>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x18>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x19>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x20>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x21>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x22>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x23>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x24>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x25>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x26>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x27>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x28>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x29>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x30>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x31>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x32>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x33>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x34>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x35>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x36>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x37>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x38>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x39>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x40>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x41>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x42>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x43>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x44>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x45>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x46>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x47>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x48>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x49>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x50>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x51>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x52>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x53>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x54>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x55>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x56>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x57>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x58>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x59>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x60>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x61>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x62>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x63>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x64>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x65>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x66>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x67>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x68>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x69>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x70>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x71>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x72>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x73>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x74>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x75>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x76>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x77>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x78>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x79>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x80>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x81>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x82>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x83>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x84>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x85>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x86>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x87>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x88>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x89>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x90>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x91>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x92>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x93>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x94>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x95>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x96>>().get() != nullptr);
    result+=(injector.create<std::unique_ptr<x97>>().get() != nullptr);
...
//time clang++ exposed.cpp -std=c++1y -I../../include -O2 -D"EXPOSED_OR_AUTO(t1, t2)=t1" -D"BOOST_DI_INJECT(type,...)=type(__VA_ARGS__)"
