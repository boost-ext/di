...
BOOST_AUTO_TEST_CASE(one_scope) {
    ...
    BOOST_CHECK((
        contains_all<
            mpl::vector<
                fake_dependency_base_of<scopes::shared<>, c0if0, c0if0>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(many_shared) {
    ...
    BOOST_CHECK((
        contains_all<
            mpl::vector<
                fake_dependency_base_of<scopes::shared<>, c1, c1>::type
              , fake_dependency_base_of<scopes::shared<>, c2, c2>::type
              , fake_dependency_base_of<scopes::shared<>, c3, c3>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(named_type) {
    ...
    BOOST_CHECK((
        contains_all<
            mpl::vector<
                fake_dependency_base_of<scopes::shared<>, c1, c1, int>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(named_when) {
    struct injector_type
        : injector<
              shared<
                  bind<c1>::named<int>::when<double>
                , bind<c2>::named<double>::when<int>
              >
          >
    { };
    ...
    BOOST_CHECK((
        contains_all<
            mpl::vector<
                fake_dependency_base_of<scopes::shared<>, c1, c1, int, double>::type
              , fake_dependency_base_of<scopes::shared<>, c2, c2, double, int>::type
            >,
            injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(when_named) {
    struct injector_type
        : injector<
              shared<
                  bind<c1>::when<double>::named<int>
                , bind<c2>::when<int>::named<double>
              >
          >
    { };
...
BOOST_AUTO_TEST_CASE(bind_if) {
    ...
    BOOST_CHECK((
        contains_all<
            mpl::vector<
                fake_dependency_base_of<scopes::shared<>, if0, c0if0>::type
            >
          , injector_type::deps
        >::value
    ));
    ...
    struct injector_type
        : injector<
            ...
            , unique<
                c6
              >
            , shared<c7>::named<double>::when<c1>
          >
    { };
    ...
    BOOST_CHECK((
        contains_all<
            mpl::vector<
                fake_dependency_base_of<scopes::shared<>, if0, c0if0>::type
              , fake_dependency_base_of<scopes::shared<>, c1, c1>::type
              , fake_dependency_base_of<scopes::shared<>, c2, c2, int>::type
              , fake_dependency_base_of<scopes::shared<>, c3, c3, void, call_stack<c4, c5>>::type
              , fake_dependency_base_of<scopes::unique<>, c6, c6>::type
              , fake_dependency_base_of<scopes::shared<>, c7, c7, double, c1>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(multiple_calls) {
    struct injector_type
        : injector<
              shared<
                  bind<c0>::when<c1, call_stack<c2, c3>, c4 >
              >
            , bind<c5>::when<int, double>
          >
    { };
    ...
    BOOST_CHECK((
        contains_all<
            mpl::vector<
                fake_dependency_base_of<scopes::shared<>, c0, c0, void, c1, call_stack<c2, c3>, c4>::type
...
BOOST_AUTO_TEST_CASE(namedwhen) {
    auto injector_ = injector<>()(
        shared<
            bind<c1>::named<int>::when<double>
          , bind<c2>::named<double>::when<int>
...
BOOST_AUTO_TEST_CASE(to_when_named) {
    ...
    auto injector_ = injector<>()(
        bind<int>::when<c4>::named<mpl::string<'1'>>::to(i1)
      , bind<int>::when<c4>::named<mpl::string<'2'>>::to(i2)
      , bind<c0if0>()
    );
...
BOOST_AUTO_TEST_CASE(to_named_when) {
    ...
    auto injector_ = injector<>()(
        bind<int>::named<mpl::string<'1'>>::when<c4>::to(i1)
      , bind<int>::named<mpl::string<'2'>>::when<c4>::to(i2)
      , bind<c0if0>()
    );
