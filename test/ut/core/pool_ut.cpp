...
BOOST_AUTO_TEST_CASE(empty) {
    typedef pool<aux::mpl::x11::vector<>> pool_type;
...
BOOST_AUTO_TEST_CASE(pool_of_pools) {
    typedef allocator<trivial_ctor> trivial_ctor_type;
    typedef allocator<default_ctor> default_ctor_type;
    typedef pool<aux::mpl::x11::vector<default_ctor_type>> pool_1_type;
    typedef pool<aux::mpl::x11::vector<trivial_ctor_type>> pool_2_type;
    typedef pool<aux::mpl::x11::vector<pool_1_type, pool_2_type>> pool_type;
    default_ctor_type default_ctor_(new default_ctor);
    trivial_ctor_type trivial_ctor_(new trivial_ctor);
...
BOOST_AUTO_TEST_CASE(init_pool_from_other_empty_pool) {
    pool<aux::mpl::x11::vector<>> pool_empty_;
    pool<aux::mpl::x11::vector<default_ctor>> pool_(pool_empty_, init());
...
BOOST_AUTO_TEST_CASE(pool_from_pool_of_pools) {
    typedef pool<aux::mpl::x11::vector<custom_ctor>> pool_type;
    typedef pool<aux::mpl::x11::vector<pool_type>> pool_pool_type;
    const int i = 42;
...
BOOST_AUTO_TEST_CASE(pool_from_pool_of_pools_many) {
    typedef pool<aux::mpl::x11::vector<custom_ctor, default_ctor>> pool_type;
    typedef pool<aux::mpl::x11::vector<pool_type>> pool_pool_type;
    const int i = 42;
...
{
public:
    typedef aux::mpl::x11::vector<T1, T2> types;
};

BOOST_AUTO_TEST_CASE(pool_flatten) {
    typedef pool<aux::mpl::x11::vector<trivial_ctor, custom_ctor, default_ctor>> pool_flatten_type;
    typedef pool<aux::mpl::x11::vector<custom_ctor, base<trivial_ctor, default_ctor>>> pool_type;
    const int i = 42;
