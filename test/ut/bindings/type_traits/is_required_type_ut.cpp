...
BOOST_AUTO_TEST_CASE(sequence_type) {
    BOOST_CHECK((!is_required_type<type_list<int, double>>::apply<fake_data<void>>::type::value));

    BOOST_CHECK((is_required_type<type_list<int, double>>::apply<fake_data<int>>::type::value));
    BOOST_CHECK((is_required_type<type_list<int, double>>::apply<fake_data<double>>::type::value));
    BOOST_CHECK((is_required_type<type_list<i1, i2>>::apply<fake_data<impl>>::type::value));
    BOOST_CHECK((is_required_type<type_list<i1>>::apply<fake_data<impl>>::type::value));
    BOOST_CHECK((is_required_type<type_list<int, i2>>::apply<fake_data<impl>>::type::value));
}
