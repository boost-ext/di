    ...
    BOOST_CHECK((
        contains_all<
            type_list<
              ...
              , fake_dependency<scopes::deduce, c3, c3, no_name, type_list<context<c4, c5>>>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(when) {
    struct injector_type
        : injector<
              unique<bind<c1>::when<context<c2>>>
          >
    { };
    ...
    BOOST_CHECK((
        contains_all<
            type_list<
                fake_dependency<scopes::unique<>, c1, c1, no_name, type_list<context<c2>>>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(named_context) {
    struct injector_type
        : injector<
              shared<
                  bind<c1>::named<int>::when<context<double>>
                , bind<c2>::named<double>::when<context<int>>
              >
          >
    { };
    ...
    BOOST_CHECK((
        contains_all<
            type_list<
                fake_dependency<scopes::shared<>, c1, c1, int, type_list<context<double>>>::type
              , fake_dependency<scopes::shared<>, c2, c2, double, type_list<context<int>>>::type
            >,
            injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(when_named) {
    struct injector_type
        : injector<
              shared<
                  bind<c1>::when<context<double>>::named<int>
                , bind<c2>::when<context<int>>::named<double>
              >
          >
    { };
    ...
    struct injector_type
        : injector<
            ...
            , unique<
                c6
              >
            , shared<bind<c7>::named<double>::when<context<c1>>>
          >
    { };
    ...
    BOOST_CHECK((
        contains_all<
            type_list<
              ...
              , fake_dependency<scopes::shared<>, c3, c3, no_name, type_list<context<c4, c5>>>::type
              , fake_dependency<scopes::unique<>, c6, c6>::type
              , fake_dependency<scopes::shared<>, c7, c7, double, type_list<context<c1>>>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(named_when_complex) {
    struct injector_type
        : injector<
              unique<
                  bind<int, int_<1>>
                , bind<int, int_<4>>::named<mpl::string<'2'>>::when<context<c7, c6, c4>>
                , bind<int, int_<5>>::when<context<c2>>
              >
          >
    { };
...
BOOST_AUTO_TEST_CASE(multiple_calls) {
    struct injector_type
        : injector<
              shared<
                  bind<c0>::when<context<c1>, context<c2, c3>, context<c4>>
              >
            , bind<c5>::when<context<int>, context<double>>
          >
    { };
    ...
    BOOST_CHECK((
        contains_all<
            type_list<
                fake_dependency<scopes::shared<>, c0, c0, no_name, type_list<context<c1>, context<c2, c3>, context<c4>>>::type
              , fake_dependency<scopes::deduce, c5, c5, no_name, type_list<context<int>, context<double>>>::type
            >
          , injector_type::deps
        >::value
    ));
...
BOOST_AUTO_TEST_CASE(to_when) {
    ...
    using injector_t = injector<
        decltype(bind<int>::when<context<c3>>::to(int()))
    >;

    auto injector_ = injector_t(
        bind<int>::when<context<c3>>::to(i)
    );
...
BOOST_AUTO_TEST_CASE(to_when_named) {
    ...
    using injector_t = injector<
        decltype(bind<int>::when<context<c4>>::named<mpl::string<'1'>>::to(int()))
      , decltype(bind<int>::when<context<c4>>::named<mpl::string<'2'>>::to(int()))
      , decltype(bind<c0if0>())
    >;

    auto injector_ = injector_t(
        bind<int>::when<context<c4>>::named<mpl::string<'1'>>::to(i1)
      , bind<int>::when<context<c4>>::named<mpl::string<'2'>>::to(i2)
      , bind<c0if0>()
    );
...
BOOST_AUTO_TEST_CASE(to_named_when) {
    ...
    using injector_t = injector<
        decltype(bind<int>::named<mpl::string<'1'>>::when<context<c4>>::to(int()))
      , decltype(bind<int>::named<mpl::string<'2'>>::when<context<c4>>::to(int()))
      , decltype(bind<c0if0>())
    >;

    auto injector_ = injector_t(
        bind<int>::named<mpl::string<'1'>>::when<context<c4>>::to(i1)
      , bind<int>::named<mpl::string<'2'>>::when<context<c4>>::to(i2)
      , bind<c0if0>()
    );
...
BOOST_AUTO_TEST_CASE(to_when_with_global) {
    ...
    auto injector_ = injector_t(
        bind<int>::when<context<c3>>::to(i1)
      , bind<int>::to(i2)
    );
...
BOOST_AUTO_TEST_CASE(to_when_stack) {
    ...
    using injector_t = injector<
        decltype(unique<c3>())
      , decltype(bind<int>::when<context<c4, c3>>::to(int()))
      , decltype(bind<c0if0>())
    >;
    ...
    auto injector_ = injector_t(
        unique<
            c3
        >()
      , bind<int>::when<context<c4, c3>>::to(i)
      , bind<c0if0>()
    );
