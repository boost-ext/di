...
test make_plain_types = [] {
    auto test = [] (auto type) {
        ...
        expect(std::is_same<T, make_plain_t<const T&>>{});
        expect(std::is_same<T, make_plain_t<T&>>{});
        expect(std::is_same<T, make_plain_t<aux::shared_ptr<T>>>{});
        expect(std::is_same<T, make_plain_t<const aux::shared_ptr<T>&>>{});
        expect(std::is_same<T, make_plain_t<aux::shared_ptr<T>&>>{});
        ...
        expect(std::is_same<T, make_plain_t<named<aux::shared_ptr<T>, void>>>{});
        expect(std::is_same<T, make_plain_t<named<const aux::shared_ptr<T>&, void>>>{});
        expect(std::is_same<T, make_plain_t<const named<const aux::shared_ptr<T>&, void>&>>{});
        expect(std::is_same<T, make_plain_t<T&&>>{});
        expect(std::is_same<T, make_plain_t<const T&&>>{});
    };
