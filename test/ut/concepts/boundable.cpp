...
test bind_static_expected_given = [] {
...
test bind_deps = [] {
  ...
  static_expect(
      std::is_same<type_<int>::is_neither_a_dependency_nor_an_injector, boundable<aux::type_list<int>>>::value);
};
...
test bind_injector = [] {
  ...
  static_expect(
      std::is_same<type_<double>::is_bound_more_than_once, boundable<aux::type<int, double, float, double>>>::value);
};
