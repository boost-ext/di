...
test traits = [] {
  ...
  static_expect(
      std::is_same<std::unique_ptr<int, deleter<int>>, rebind_traits_t<std::unique_ptr<_, deleter<_>>, int>>{});
  ...
  static_expect(
      std::is_same<named<void, boost::shared_ptr<int>>, rebind_traits_t<boost::shared_ptr<int>, named<void>>>{});
