...
//
    ...
    #ifndef BOOST_DI_BACK_SCOPE_PER_REQUEST_HPP
    #define BOOST_DI_BACK_SCOPE_PER_REQUEST_HPP
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_DI_FUNCTION_ARITY_LIMIT_SIZE, "di/back/scopes/per_request.hpp"))
