...
//
#ifndef BOOST_DI_BACK_AUX_EXPLICIT_VALUE_HPP
#define BOOST_DI_BACK_AUX_EXPLICIT_VALUE_HPP
...
template<typename, typename = void> class explicit_value : public boost::mpl::false_ { };

template<BOOST_PP_ENUM_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, int C)>
class explicit_value< boost::mpl::string<BOOST_PP_ENUM_PARAMS(BOOST_MPL_STRING_MAX_PARAMS, C)> > : public boost::mpl::true_
{
public:
...
template<typename T>
class explicit_value<T, typename boost::enable_if< detail::has_value<T> >::type> : public boost::mpl::true_
{
public:
