...
//
    ...
    #ifndef BOOST_DI_BACK_AUX_DEPENDENCY_HPP
    #define BOOST_DI_BACK_AUX_DEPENDENCY_HPP
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_DI_FUNCTION_ARITY_LIMIT_SIZE, "di/back/aux/dependency.hpp"))
