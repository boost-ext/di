...
//
    ...
    #ifndef BOOST_DI_BACK_POLICIES_CHECK_FOR_CIRCULAR_DEPENDENCIES_HPP
    #define BOOST_DI_BACK_POLICIES_CHECK_FOR_CIRCULAR_DEPENDENCIES_HPP
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_DI_FUNCTION_ARITY_LIMIT_SIZE, "di/back/policies/check_for_circular_dependencies.hpp"))
